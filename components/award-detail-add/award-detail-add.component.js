angular.
module('awardDetailAdd').
component('awardDetailAdd', {
  ...
  controller: [ function AwardDetailAddController() {
      let $ctrl = this;

      $ctrl.$onChanges = function(changes) {
        $ctrl.newAwardStartDate = $ctrl.application.employee.salaryHistory[0]._startDate;
