...
component('applicationDetail', {
  ...
  controller: [
    ...
    '$window',
    '$uibModal',
    function ApplicationDetailController($scope, $http, $routeParams, $location, $window, $uibModal) {
      var $ctrl = this;
      ...
      $ctrl.reviewAward = function(){
        $uibModal.open({
          template: '<award-detail-add  application="$ctrl.application" $close="$close(result)" $dismiss="$dismiss(reason)"></award-detail-add>',
